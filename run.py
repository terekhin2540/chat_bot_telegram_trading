...
from modules.datadase.module import add_to_bd_module, delete_from_bd_module
...
bot.register(add_to_bd_module, ['добавить в базу', 'база', 'id'], "А если напишешь мне 'база', то я зарегистрирую тебя!!")
bot.register(delete_from_bd_module, ['удалить из базы', 'удалить'], "А если напишешь мне 'удалить', то я удалю тебя!!")
