...
class ObjectDetection(BaseModule):
    def run(self, update, context):
        ...
        self.context.bot.send_message(chat_id=update.effective_chat.id, text=text)
        self.bot.send_photo(chat_id=update.effective_chat.id, photo=open('image_result.jpg', 'rb'))
